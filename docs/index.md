...
The pqverse is a set of R packages for metabarcoding analysis that share
the [phyloseq](https://joey711.github.io/phyloseq/) object as their
central data structure. Installing and loading `pqverse` attaches all
member packages in a single step, much like the
